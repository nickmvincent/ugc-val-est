"""
Tests pass but don't have full coverage
"""
...
def test_blocking():
	...
	ids = list(range(len(Y2)))
	causal2 = c.CausalModel(Y2, D2, X2, ids=ids)
	strata = [causal1, causal2]

	adj1 = 0
	# TODO
	blocking1 = b.Blocking(strata, adj1, feature_names=[], skip_features=[])
	ate1 = 4.714286
	atc1 = 4.714286
	att1 = 4.714286
	ate_se1 = 10.18945
	...
	adj2 = 1
	blocking2 = b.Blocking(strata, adj2, feature_names=[], skip_features=[])
	ate2 = 1.657703
	atc2 = 1.657703
	att2 = 1.657703
	ate_se2 = 10.22921
	...
	adj3 = 2
	blocking3 = b.Blocking(strata, adj3, feature_names=[], skip_features=[])
	ate3 = 17.83044057
	atc3 = 35.45842407
	att3 = 0.20250793
	ate_se3 = 11.42591
